...
* Our hypothesis for this section is that similar photos get uploaded for similiar businesses. 
...
* In this section we'll need to first identify photos that are similiar and then group them. 
